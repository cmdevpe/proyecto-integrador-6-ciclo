<div class="mt-14">
    ...
    <x-modal name="category-form-modal" maxWidth="lg" :static="true">
        <x-slot:header>
            <h3 class="text-xl font-semibold">{{ $form->category_id ? 'Editar categoría' : 'Crear nuevo categoría' }}
            </h3>
        </x-slot:header>
        <x-slot:body>
            <form class="space-y-4 md:space-y-5" wire:submit.prevent="save"
                ...
                <div class="flex items-center space-x-2">
                    <x-button type="submit" wireTarget="save" class="px-4 py-2">
                        ...
                        <x-slot:loading>
                            {{ $form->category_id ? 'Actualizando categoría' : 'Creando nuevo categoría' }}
                        </x-slot:loading>
                        {{ $form->category_id ? 'Actualizar categoría' : 'Crear nuevo categoría' }}
                    </x-button>
